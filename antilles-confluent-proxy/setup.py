...
setup(
    ...
    namespace_packages=['antilles', 'antilles.proxy'],
    ...
    entry_points={
        'paste.app_factory': [
            'main = antilles.proxy.confluent.factory:app_factory',
            'cluster = antilles.proxy.confluent.factory:cluster_app_factory'
        ],
    },
    cmdclass={
        'bdist_rpm': bdist_rpm
