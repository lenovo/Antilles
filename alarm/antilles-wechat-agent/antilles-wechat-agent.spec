...
Name:           antilles-wechat-agent
Version:        1.0.0
Release:        1%{?dist}
Summary:        Wechat alarm agent for antilles project
...
%description
Wechat alarm agent for antilles project
...
%{__install} -Dp -m 0644 etc/%{name}.ini %{buildroot}%{_antillesconfdir}/wechat-agent.ini
...
%config(noreplace) %{_antillesconfdir}/wechat-agent.ini

# program
%{_antillessitedir}/antilles_wechat_agent-*-py?.?.egg
