...
BuildRequires:  python34-pytest-fixture-config
BuildRequires:  python34-pytest-virtualenv
%endif # with tests
%if %{without bootstrap}
BuildRequires:  python34-pip
BuildRequires:  python34-wheel
%endif # without bootstrap
%endif # with python3
...
Group:          Applications/System
%{?python_provide:%python_provide python34-setuptools}
